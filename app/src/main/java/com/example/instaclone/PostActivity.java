        ...
        if(imageUri!=null){
            ...
            uploadtask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    DatabaseReference mHashRef=FirebaseDatabase.getInstance().getReference().child("HashTags");
            ...
            Toast.makeText(this, "Please select some picture", Toast.LENGTH_SHORT).show();
        }
    }
